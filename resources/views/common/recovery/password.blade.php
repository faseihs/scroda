        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 text-center">
                ...
                <div class="user-ath-box">
                    ...
                    @endif
                    <form method="POST" action="{{ route('password.update') }}" class="user-ath-form">
                    @csrf
                    ...
                    <!--
                        ...
                        <div class="input-item">
                            <input required type="email" name="email" placeholder="Your Email" class="input-bordered {{ $errors->has('email') ? ' is-invalid' : '' }}">
                            @if ($errors->has('email'))
                        ...
                        <div class="gaps"></div>
                        <div class="input-item">
                            <input required type="password" name="password" placeholder="New Password" class="input-bordered {{ $errors->has('email') ? ' is-invalid' : '' }}">
                        ...
                        <div class="gaps"></div>
                        <div class="input-item">
                            <input required type="password" name="password_confirmation" placeholder="Confirm Password" class="input-bordered {{ $errors->has('email') ? ' is-invalid' : '' }}">

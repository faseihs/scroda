        ...
        <div class="d-flex">
            <div class="user-sidebar">
                ...
                <ul class="user-icon-nav">
                    <li><a href="/admin/dashboard"><em class="ti ti-dashboard"></em>Dashboard</a></li>
                    <li><a href="/admin/clients"><em class="ti ti-user"></em>Clients</a></li>
